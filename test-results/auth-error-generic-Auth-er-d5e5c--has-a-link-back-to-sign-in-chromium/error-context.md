...
- Name: auth-error-generic.spec.ts >> Auth error page — static, no ?error= reflection >> page has a link back to sign-in
- Location: e2e/auth-error-generic.spec.ts:50:7
