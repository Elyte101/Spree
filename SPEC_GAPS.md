...
| G24 | Admin: in-app chat seller/buyer↔admin ONLY | missing | medium | N/A | Requires new ChatMessage model, polling or WebSocket infra, and full admin+user chat UI. Deferred — no existing code to stub; building from scratch is out of scope for this QA pass. |
